...
for path in listdir("./Lab4/Data"):
    ...
    GeneticRoute(100, 100, 500, 0.5, data[:, 1:]).run(show_plot=True, show_plot_animation=False, show_convergence=True)  # , save_plot=f"./Lab4/Images/an.{path}.png", save_convergence=f"./Lab4/Images/conv.{path}.png")  #, save_plot="./Lab4/Images/an.3.png", save_convergence="./Lab4/Images/conv.3.png"

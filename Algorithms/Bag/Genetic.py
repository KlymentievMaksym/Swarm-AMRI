...
def Genetic(iterations: int, pop_size: int, child_size: int, max_capacity: float, weight_price: list[list[float, float]], **kwargs):
...
if __name__ == "__main__":
    weigth_max, data = Generator(10, min_amount=10).generate()
    best_f, best_items_choose = Genetic(1000, 10, 100, weigth_max, data)

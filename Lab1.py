...
# Genetic(20, 40, 30, 8, f_one_extremum, [[0, 7]], d1=True, show=True, save="Lab1/Images/Genetic.gif").run()
...
# g = Genetic(150, 100, 50, 8, Reductor, Reductor_limits, d2=True, show=True, break_faster=False, savep="Lab1/Images/Genetic_11.png", integer=[2]).run()
